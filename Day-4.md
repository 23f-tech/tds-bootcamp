...
--- Before Day-4 ---
I already knew basic Python scripting and had some idea about websites sending requests and receiving responses.
--- 
...
--- After Day-4 ---
I learned the basics of HTTP methods, status codes, browser network inspection, cURL requests, and testing simple FastAPI endpoints.
---

--- Feedback (Suggestions for the TDS Team) ---
The Day-4 checklist was useful. A small sample FastAPI app and cURL examples would make the tasks easier to practice.
---
