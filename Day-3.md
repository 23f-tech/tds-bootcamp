...
--- Before Day-3 ---
I already knew basic Python scripting and simple terminal commands.
--- 
...
--- After Day-3 ---
I learned how to run Python scripts using `uv`, manage dependencies, create projects, and understand virtual environments better.
---

--- Feedback (Suggestions for the TDS Team) ---
The Day-3 checklist was useful. A simple example comparing `uv run`, `uv add`, and `uv venv` would make it easier to follow.
---
...
Personal Notes:
I am comfortable with basic Python, but I need more practice with `uv`, dependency management, and choosing the correct Python interpreter in VS Code.
